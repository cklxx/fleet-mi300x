...
Author: Kailun Chen · Status: v0.13 (measured on the MI300X; v0.8 is the submitted proposal, kept verbatim in `docs/task/`) · Target: single MI300X (gfx942), BF16, bs=1, 1024-token context, 32 greedy tokens
