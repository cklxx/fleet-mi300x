...
| Per-token latency, median / p95, one cooperative launch for all 32 tokens | **3.60 ms / 3.61 ms (278 tok/s)**, three runs within 3.593–3.596; first correct version was 22.05 ms |
